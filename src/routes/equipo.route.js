...
router.get('/filtrar',            getEquiposFiltrados);
router.get('/check',              checkEquipoRoute);
router.post('/marca-modelo-dni',  getEquipoByMarcaModeloDni); // buscar equipo por marca, modelo y DNI
router.get('/tipo/:tipo',         getEquiposByTipo);
router.get('/cliente/:cliente_id', getEquiposByCliente);      // equipos de un cliente
router.get('/:id',                getEquipoById);
router.put('/:id',                updateEquipo);
router.delete('/:id',             deleteEquipo);
